...
;(function(window) {
	...
	function init() {
			...
			tweens : [
				...
				new mojs.Tween({
					...
					onUpdate: function(progress) {
						...
						el10.style.color = colorProgress ? '#ec9b1b' : '#ccc';
					}
				})
			],
			onCheck : function() {
			...
			tweens : [
				...
				new mojs.Tween({
					...
					onUpdate: function(progress) {
						...
						el11.style.color = colorProgress >= 1 ? '#ec9b1b' : '#ccc';
					}
				})
			],
			onUnCheck : function() {
				el11.style.color = '#ccc';	
			}
		});
		/* Icon 11 */
			...
			tweens : [
				...
				new mojs.Tween({
					...
					onUpdate: function(progress) {
						...
						el12.style.color = colorProgress ? '#ec9b1b' : '#ccc';
					}
				})
			],
			onUnCheck : function() {
				el12.style.color = '#ccc';	
			}
		});
		/* Icon 12 */
		...
		new Animocon(el13, {
			...
			onCheck : function() {
				el13.style.color = '#ec9b1b';
			},
			onUnCheck : function() {
				el13.style.color = '#ccc';	
			}
		});
		/* Icon 13 */
			...
			tweens : [
				...
				new mojs.Tween({
					...
					onUpdate: function(progress) {
						...
						el15.style.color = colorProgress ? '#ec9b1b' : '#ccc';
					}
				})
			],
			onUnCheck : function() {
				el15.style.color = '#ccc';
			}
		});
		/* Icon 15 */
			...
			tweens : [
				...
				new mojs.Tween({
					...
					onUpdate: function(progress) {
						...
						el16.style.color = progress >= 0.75 ? '#ec9b1b' : '#ccc';
					}
				})
			],
			onUnCheck : function() {
				el16.style.color = '#ccc';
			}
		});
		/* Icon 16 */
